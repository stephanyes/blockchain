...
def create_app():
    ...
    CORS(app, resources={r"/*": {"origins": os.environ.get("CORS_ALLOWED_ORIGINS", "http://localhost:3000")}})
    ...
    def handle_preflight():
        if request.method == "OPTIONS":
            ...
            response = jsonify()
            response.headers['Access-Control-Allow-Origin'] = os.environ.get("CORS_ALLOWED_ORIGINS", "http://localhost:3000")
